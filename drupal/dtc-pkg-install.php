...
function do_package_install(){
  ...
  $package_installer_console .= "=> Starting Drupal Installer for Drupal 4.7.2<br>";
  ...
  $package_installer_console .= "=> Inserting the Drupal 4.7.2 database schemas for you MySQL: ".$mysql_ver."<br>";
  ...
  $package_installer_console .= "=> Changing Drupal Drupal 4.7.2 configuration file...<br>";
